...
Un Webhook recibe cualquier petición POST enviada al endpoint honey-trap-access.

2\. Análisis del User‑Agent

En un Code Node se evalúa el encabezado User-Agent:
...
El análisis del encabezado User-Agent es un método eficaz para detectar actividad automatizada porque muchas herramientas ofensivas incluyen identificadores claros en este campo. Esto permite distinguir entre:
